...
logo = PhotoImage(file="redbox.gif")      # Loading all the image files that are required in the game.
logo2 = PhotoImage(file="background.gif")     # Loading all the image files that are required in the game.
logo3 = PhotoImage(file="red.gif")          # Loading all the image files that are required in the game.
logo4 = PhotoImage(file="background.gif")
logo5 = PhotoImage(file="background.gif")
logo6 = PhotoImage(file="background.gif")
logo7 = PhotoImage(file="center.gif")
logoxx = PhotoImage(file="test.gif")
logog = PhotoImage(file="greenbox.gif")
logogs = PhotoImage(file="greenbox.gif")
logoy = PhotoImage(file="greenbox.gif")
logoys = PhotoImage(file="greenbox.gif")
logob = PhotoImage(file="greenbox.gif")
logobs = PhotoImage(file="greenbox.gif")
logor = PhotoImage(file="greenbox.gif")
logors = PhotoImage(file="greenbox.gif")
...
def turn():   #Prints whoose turn is it
    ...
    if RED == True:
        L2 = Label(root, text="   Red's Turn    ", fg='Red', background='white', font=("Arial", 24, "bold"))
        L2.place(x=770, y=50)

    if BLUE == True:
        L2 = Label(root, text="   Blue's Turn   ", fg='Blue', background='white', font=("Arial", 24, "bold"))
        L2.place(x=770, y=50)

    if GREEN == True:
        L2 = Label(root, text="Green's Turn  ", fg='Green', background='white', font=("Arial", 24, "bold"))
        L2.place(x=770, y=50)

    if YELLOW == True:
        L2 = Label(root, text="Yellow's Turn", fg='Yellow', background='white', font=("Arial", 24, "bold"))
        L2.place(x=770, y=50)
...
def roll():   #Rolling function that rolls a dice, goes again if its a six
    ...
    if TURN == True:
        ...
        if rollc == 1:
            ...
            L1 = Label(root, text=dice, fg='Black', background='white', font=("Arial", 24, "bold"))
        ...
        if rollc == 2:
            if dice == 6:
                ...
                L3 = Label(root, text=dice1, fg='Black', background='white', font=("Arial", 24, "bold"))
        ...
        if rollc == 3:
            if dice1 == 6:
                ...
                L4 = Label(root, text=dice2, fg='Black', background='white', font=("Arial", 24, "bold"))
...
def clear():        #clears all the variable prior to next player's turn
    ...
    del rolls[:]
    TURN = True
    L1 = Label(root, text="        ", fg='Black', background='white', font=("Arial", 24, "bold"))
    L1.place(x=800, y=200)
    L3 = Label(root, text="        ", fg='Black', background='white', font=("Arial", 24, "bold"))
    L3.place(x=800, y=250)
    L4 = Label(root, text="        ", fg='Black', background='white', font=("Arial", 24, "bold"))
    L4.place(x=800, y=300)
    print("cleared")
    turn()
...
def movecheck(r, rh, rb, la):       #Check if the player can make a move
    ...
    if win == True:                                         #If all gamepieces home, prints that the player has won
        print("YOU HAVE WON")
        L2 = Label(root, text=(la + "Wins"), fg='Black', background='white', font=("Arial", 24, "bold"))
